...
docker run --hostname ng2 --name ng2 -p 81:8080 -v /Users/N224874/Library/CloudStorage/OneDrive-SantanderOffice365/Documentos/MisProyectos/nginx-course/nginx-udemy-container/nginx.conf:/etc/nginx/nginx.conf -d nginx
